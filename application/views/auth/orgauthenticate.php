...
<body id="" style="font-family: 'forum';">
    <main>
                ...
                <div class="col-lg-10 mt-5">
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4  col-sm-12 p-3 p-lg-1">
                            <div class="card shadow border-info rounded-0">
                                <div class="card-content">
                                    ...
                                    <form class="" id="myForm" action="<?= base_url('auth/userauthenticate') ?>" method="post" novalidate="novalidate">
                                        ...
                                        <div class="">
                                            <button class="btn waves-effect btn-block blue waves-light" type="submit" name="action">Login<i class="material-icons right">send</i> </button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-md-8 d-none d-md-block text-ctr">
                            <div class="row justify-content-center">
                                <!-- <div class="col-lg-5 col-6">
                                    <img src="https://demo.skulam.com/assets/skulam-white-logo.svg" alt="Skulam" class="img-fluid">
                                </div> -->
                                <div class="col-lg-5"></div>
                                <div class="col-lg-7"><h1 class="float-right text-info">A Smart Class <br>Application!</h1></div>
                            </div>
        ...
        <div class="footer-copyright p-3 pb-5 float-right">
            <div class="container text-ctr float-right">
                <h6>Powered by<b><a href="https://www.webjagriti.com" target="_blank" class=" nav-link d-inline">Webjagriti</a></b> </h6>
            </div>
        </div>
    </main>
