        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="<?= base_url('org/profile') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
             <!-- NOTIFICATION  -->
            <div class="col-md-4 col-sm-6 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner p-3">
                       <h3><?= $this->admin_datawork->count_all('notification'); ?></h3>
                        <h5>Notification</h5>
                    </div>
                    <div class="icon">
                        <i class="fa fa-bell"></i>
                    </div>
                    <a href="<?= base_url('org/notification') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
             <!-- SYLLABUS  -->
            <div class="col-md-4 col-sm-6 col-6">
                ...
                <div class="small-box bg-primary">
                    <div class="inner p-3">
                       <h3><?= $this->admin_datawork->count_all('course'); ?></h3>
                        <h5>Syllabus</h5>
                    </div>
                    <div class="icon">
                        <i class="fa fa-file-pdf-o"></i>
                    </div>
                    <a href="<?= base_url('org/syllabus') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-6">
                <div class="small-box bg-primary">
                    ...
                    <a href="<?= base_url('org/subject') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- TOTAL TOPICS -->
            <div class="col-md-4 col-sm-6 col-6">
