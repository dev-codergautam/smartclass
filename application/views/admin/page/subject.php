        ...
        <form name="myForm" class="form-horizontal" id="myForm" action="<?= base_url('admin/addNewSubject'); ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="form-group col-4">
                    <label for="name">Subject  / Lession</label>
        ...
        <div style="overflow-x:scroll">
            <table id="pass" class="table table-hover table-sm table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?php echo $sub->subName; ?> <span class="badge float-right badge-pill badge-info">
                                <?= ( $this->admin_datawork->count_data('subjects',['subParent'=>$sub->subId]) ) ?></span>
                        </td>
                        <td>
                            <?php $topic = $this->datawork->get_data('subjects', ['subParent' => $subId]); ?>
                            <?php foreach($topic as $topic): ?>
                            <?php echo $topic->subName; ?> , &nbsp; &nbsp; &nbsp;
                            <?php endforeach; ?>
                        </td>
                        <td class="text-center">
                            <a href="<?= base_url(); ?>admin/topics/<?= $sub->subId; ?>" class="btn btn-sm mx-1 btn-info"><i class="fa fa-eye"></i></a>
